...
{
    public class WebServiceManagementService : AppService<WebServiceManagementModel, WebServiceManagementDto, WebServiceManagementRequest, int> , IWebServiceManagementService
    {
